...
class PlaneRCNNConvFCHead(nn.Module):
    ...
    def __init__(self, cfg, input_shape: ShapeSpec):
        ...
        # fmt: off
        num_conv        = cfg.MODEL.ROI_PLANE_HEAD.NUM_CONV
        conv_dim        = cfg.MODEL.ROI_PLANE_HEAD.CONV_DIM
    ...
    def forward(self, x, instances):
        ...
        if self.training:
            return {"loss_plane": plane_rcnn_loss(x, instances, loss_weight=self._loss_weight, 
