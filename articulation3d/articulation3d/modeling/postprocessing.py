...
from articulation3d.layers import paste_masks_in_image


def detector_postprocess(results, output_height, output_width, mask_threshold=0.5, box_score_threshold=0.7, nms=False):
    """
