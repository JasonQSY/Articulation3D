...
def deconv2d(scale_factor=2, mode='nearest', in_channels=256, out_channels=128, kernel_size=3, stride=1, padding=1):
    return nn.Sequential(
...
class PlaneRCNNDepthHead(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        self.conv1 = conv2d(in_channels=256, out_channels=128, kernel_size=3, stride=1, padding=1)
        self.conv2 = conv2d(in_channels=256, out_channels=128, kernel_size=3, stride=1, padding=1)
        self.conv3 = conv2d(in_channels=256, out_channels=128, kernel_size=3, stride=1, padding=1)
        self.conv4 = conv2d(in_channels=256, out_channels=128, kernel_size=3, stride=1, padding=1)
        self.conv5 = conv2d(in_channels=256, out_channels=128, kernel_size=3, stride=1, padding=1)
        self.deconv1 = deconv2d(in_channels=128, out_channels=128, kernel_size=3, stride=1, padding=1)
        self.deconv2 = deconv2d(in_channels=256, out_channels=128, kernel_size=3, stride=1, padding=1)
        self.deconv3 = deconv2d(in_channels=256, out_channels=128, kernel_size=3, stride=1, padding=1)
        self.deconv4 = deconv2d(in_channels=256, out_channels=128, kernel_size=3, stride=1, padding=1)
        self.deconv5 = deconv2d(in_channels=256, out_channels=64, kernel_size=3, stride=1, padding=1)
    ...
    def forward(self, features, gt_depth=None):
        ...
        x = torch.nn.functional.interpolate(x, size=(15, 20), mode='bilinear', align_corners=False)
