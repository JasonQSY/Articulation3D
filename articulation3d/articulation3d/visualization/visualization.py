...
def draw_match(img1_path, img2_path, box1, box2, matching_proposals, correct_list, pred_aff=None, before=True, th=0.5, distance = 45, factor=4, vertical=True, dotsize=20, outlier_color=None):
...
def get_labeled_seg(predictions, score_threshold, vis, assigned_colors=None, paper_img=False):
